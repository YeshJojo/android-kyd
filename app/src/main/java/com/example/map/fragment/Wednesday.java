                    ...
                    if (dataSnapshot.exists()) {
                        try {
                            if (dataSnapshot.hasChild("wednesday")){
                                steps = dataSnapshot.child("wednesday").child("steps").getValue().toString();
                                dist = dataSnapshot.child("wednesday").child("distance").getValue().toString();
                                cal = dataSnapshot.child("wednesday").child("cal").getValue().toString();
