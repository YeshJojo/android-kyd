                    ...
                    if (dataSnapshot.exists()) {
                        try {
                            if (dataSnapshot.hasChild("monday")){
                                steps = dataSnapshot.child("monday").child("steps").getValue().toString();
                                dist = dataSnapshot.child("monday").child("distance").getValue().toString();
                                cal = dataSnapshot.child("monday").child("cal").getValue().toString();
                                ...
                                mChart.setProgress(progress, true);
                            } else {
                                scText.setText("0");
