                    ...
                    if (dataSnapshot.exists()) {
                        try {
                            if (dataSnapshot.hasChild("friday")){
                                steps = dataSnapshot.child("friday").child("steps").getValue().toString();
                                dist = dataSnapshot.child("friday").child("distance").getValue().toString();
                                cal = dataSnapshot.child("friday").child("cal").getValue().toString();
