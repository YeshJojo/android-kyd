                    ...
                    if (dataSnapshot.exists()) {
                        try {
                            if (dataSnapshot.hasChild("sunday")) {
                                steps = dataSnapshot.child("sunday").child("steps").getValue().toString();
                                dist = dataSnapshot.child("sunday").child("distance").getValue().toString();
                                cal = dataSnapshot.child("sunday").child("cal").getValue().toString();
